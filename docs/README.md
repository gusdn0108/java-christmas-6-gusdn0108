...
3. 특별한 날 정하기
4. 총 할인 금액에 따른 배지 부여
5. 주말에는 메인 매뉴 1개당 2023원 할인
6. 평일에는 디져트 매뉴 1개당 2023원 할인
7. 디데이 할인은 1000원으로 시작
8. 크리스마스가 다가 올 수록 날마다 +100원
9. 특정한 날 특별 할인 -1000원
10. 총혜택 금액 에 따른 이벤트 배지 부여
...
```
```java
 1. USER_INSERT_NOT_AVAILABLE_MENU("[ERROR] 유효하지 않은 주문입니다. 다시 입력해 주세요.")
 2. USER_INSERT_NOT_AVAILABLE_DAY("[ERROR] 유효하지 않은 날짜입니다. 다시 입력해 주세요.")
 3. USER_INSERT_MENU_AND_COUNT("[ERROR] 매뉴와 갯수를 입력해주세요 다시 입력해 주세요.")
 4. USER_INSERT_DUPLICATION_MENU("[ERROR] 같은 매뉴를 입력했습니다 다시 입력해 주세요.")
 5. NOT_ORDER_ONLY_DRINK("[ERROR] 음료 메뉴만 주문 할 수 없습니다")
 6. NOT_ORDER_TWENTY_MENU("[ERROR] 주문갯수는 20개 초과 주문할수없습니다")
 7. INSERT_DAY_RANGE_ERROR("[ERROR] 날짜는 1-31 까지만 입력 가능합니다")
