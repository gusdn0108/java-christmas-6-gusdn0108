...
```
```java
1. 방문 할 날짜가 1-31 이하로만 받아야한다 
2. 날짜가 숫자가 아닌경우
3. 1,2의 조건인경우 이하의 숫자가 아닌경우 [ERROR] 유효하지 않은 날짜입니다. 다시 입력해 주세요. 출력
4. 메뉴판에 없는 메뉴를 입력하는경우
5. 매뉴의 갯수가 1보다 작을경우
6. 중복 메뉴를 입력한경우 
7. 매뉴 주문 형식과 다른경우
8. 매뉴 갯수에 숫자가 아닌 다른 숫자를 입력한 경우 
9. (4,5,6,7,8)의 조건인 경우 [ERROR] 유효하지 않은 주문입니다. 다시 입력해 주세요. 출력 
10. 음료만 시켰을경우 [ERROR] 음료 메뉴만 주문 할 수 없습니다 다시 입력해 주세요" 출력
11. 주문 개수가 20개 초과일경우 [ERROR] 주문갯수는 20개 초과 주문할수없습니다 다시 입력해 주세요 출력 
